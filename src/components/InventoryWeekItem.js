...
const InventoryWeekItem = ({ item }) => {
    return (
        <div className="p-6 shadow-md my-4 flex justify-between items-center">
            <div className="flex justify-between items-center space-x-4">
                <FaCheckSquare class="text-green-500 text-2xl"/>
                <h3 className="font-bold text-lg">WEEK {item}</h3>
            </div>
            <div className="flex items-center justify-between space-x-4">
                <Link to="/app/broilers" state={{newWeek: false, week: item}} className="flex justify-between items-center bg-blue-500 text-white px-2 py-2 hover:bg-white border-2 border-blue-500 hover:text-blue-500 rounded-md space-x-2 transition-all">
                    <FiEye />
