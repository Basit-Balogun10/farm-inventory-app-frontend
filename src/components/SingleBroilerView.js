              ...
              <tbody>
                  {inventoryWeeks.map((week) => (
                      <tr class="bg-green-100">
                          ...
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.bedding_due.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.weight}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_overweight.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_underweight.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_close_to_being_overweight.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {
                                  week.broiler_report
                                      .is_close_to_being_underweight.toString().toUpperCase()
                              }
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                          ...
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.consumes_inadequate_feed.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.consumes_too_many_feed.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_close_to_being_underfed.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_close_to_being_overfed.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.temperature}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_cold.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {week.broiler_report.is_running_temperature.toString().toUpperCase()}
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {
                                  week.broiler_report
                                      .is_close_to_the_minimum_temperature.toString().toUpperCase()
                              }
                          </td>
                          <td class="text-center border-2 border-green-500 px-4 py-2">
                              {
                                  week.broiler_report
                                      .is_close_to_the_maximum_temperature.toString().toUpperCase()
                              }
                          </td>
                      </tr>
                  ))}
