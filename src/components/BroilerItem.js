...
const BroilerItem = ({ broiler, newWeek }) => {
  ...
  const FEMALE_BROILER_IMAGE_SRC =
    ...
    return (
        <div>
            <div className="pt-6 pr-6 shadow-md my-4 flex justify-between items-center">
                <img
                    ...
                    onClick={() =>
                        navigate("/app/broiler", { state: { broiler } })
                    }
                />
                <table class="table-auto overflow-scroll text-green-500">
                    <thead>
                    ...
                    <tbody>
                        <tr class="bg-green-100">
                            ...
                            <td class="text-center border-2 border-green-500 px-4 py-2">
                                {!newWeek ? broiler.color.toUpperCase() : ""}
                            </td>
                            <td class="text-center border-2 border-green-500 px-4 py-2">
            ...
            {newWeek && (
                <div className="flex items-center justify-end">
                    <button
                        ...
                        className="flex justify-between items-center bg-blue-500 text-white px-2 py-2 hover:bg-white border-2 border-blue-500 hover:text-blue-500 rounded-md space-x-2 transition-all"
                    >
                        {!formDisplay ? "Update Record" : "Close Form"}
                    </button>
                </div>
            )}
            {formDisplay && (
                <div className="flex items-center justify-center">
                    ...
                    <BroilerItemForm
                        type="number"
                        placeholder="Average Food Consumed in KG"
                        ariaLabel="Average Food Consumed"
                        buttonText="Update Quantity of Food Consumed"
                    />
                    <BroilerItemForm
                        type="number"
                        placeholder="Average Temperature in Degree-Celsius"
                        ariaLabel="Average Temperature"
                        buttonText="Update Average Temperature"
                    />
                </div>
            )}
        </div>
